...
class Api {
  ...
  static Future<MovieSuggestion> searchMovies({@required String queryTerm}) async {
  ...
  static Future<ListMovies> trendingMovies() async {
    String url = "https://yts.mx/api/v2/list_movies.json?limit=5&sort_by=download_count";
